...
public class Music {
    ...
    private void playLoop() {
        try {
            // The music should keep going while you play.
            // When one track ends, this loop just starts it again. gg.
    ...
    private Class<?> loadPlayerClass() throws Exception {
        try {
            ...
            // If the player library is not already there, look in the project's lib folder.
    ...
    private InputStream openMusic() throws Exception {
        // The song can come from the finished app or from the source files while you're still working on it.
