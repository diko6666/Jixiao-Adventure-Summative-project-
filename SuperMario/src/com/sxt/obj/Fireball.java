...
public class Fireball implements Runnable {
    ...
    public Fireball(int x, int y, boolean face_to, BackGround bg) {
        ...
        // Fireballs get their own thread so they keep flying without slowing Mario down.
        thread.start();
    }
    @Override
    public void run() {
        while (true) {
            try {
                ...
                // Move the fireball in the direction Mario was facing when he shot it.
                if (face_to) {
                    this.x -= 10;
                ...
                // If it touches a block or an enemy, the fireball is basically done.
